    ...
    return (
        <div className={styles.disclaimerAlignment}>
            <div className='container-md'>
                ...
                <p>
                    Golden Bulls 2.0 International provides market-related news, insights, analysis, and educational content for informational purposes only. All content made available on our website and across our official digital and social media channels is derived
                    from sources believed to be reliable and publicly available.
                </p>
                <p>
                    However, Golden Bulls 2.0 International does not guarantee the accuracy, adequacy, completeness, reliability, timeliness, or suitability of any information presented. All content is provided on an “as is” basis without any express or implied warranties, including but not limited to warranties of merchantability or fitness for
                ...
                <p>
                    By accessing or using any information from Golden Bulls 2.0 International, you acknowledge and agree that you do so at your own risk. Golden Bulls 2.0 International shall not be held responsible or liable for any direct, indirect, incidental, consequential, or other losses or damages—including financial loss, emotional distress, or otherwise—arising from the use of, reliance upon, or inability to use
