  ...
  return (
    <div className={styles.termsConditions}>
      <div className='container-md'>
        ...
        <p>
          You are solely responsible for maintaining the confidentiality of your login credentials, including your username and password. You agree not to share your account details with any third party. Any activity conducted through your account shall be deemed to be performed by you, whether authorized
          or not.
        </p>
        <p>
        ...
        <div className={styles.line}></div>
        <h2>
          User Information & Conduct
        </h2>
        <p>
          You agree to provide accurate, truthful, and complete information during registration and to keep your account details up to date at
          all times.
        </p>
        <p>
          You must not:
        ...
        <ul>
          <li>Create accounts using false identities or misleading information
          </li>
          <li>Impersonate another individual or entity</li>
          <li>Use the platform for unlawful, abusive, or deceptive purposes
          </li>
        </ul>
        <p>
          Users are expected to engage respectfully and professionally. Any conduct that promotes harassment, hate speech, abusive behavior, or deliberate disruption of the learning or community environment may result in immediate suspension or permanent removal from the platform. Decisions regarding such actions shall
          be final.
        </p>
        <div className={styles.line}></div>
        <h2>
        ...
        <ul>
          ...
          <li>Platform content is misused, copied, or shared without authorization
          </li>
        ...
        <p>
          These Terms shall be interpreted and enforced in accordance with applicable laws and regulations. Any disputes arising out of or relating to the use of the platform shall be subject to appropriate legal jurisdiction as determined by Golden
          Bulls International.
        </p>
      </div>
    </div>
