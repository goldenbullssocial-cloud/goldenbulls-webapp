    ...
    return (
        <div className={styles.privacyPolicy}>
            <div className='container-md'>
                ...
                <p>
                    We implement appropriate technical, administrative, and organizational safeguards to protect personal data against unauthorized access, misuse, loss, or alteration. Our security practices are reviewed periodically to align with current
                ...
                <p>
                    We reserve the right to modify, limit, suspend, or discontinue any part of the website or its functionalities at our sole
                    discretion.
                </p>
                <div className={styles.line}></div>
                <h2>
                ...
                <ul>
                    <li>Submission of false, misleading, or incomplete registration information
                    </li>
                    <li>Misuse of services for unlawful, fraudulent, or prohibited activities
                    </li>
                    <li>Unauthorized access or compromise of user credentials
                    </li>
                </ul>
                <p>
                ...
                <p>
                    Access to certain online services may be provided free of charge unless otherwise specified. Where payments are applicable, transaction-related charges will be handled as outlined at the point
                    of purchase.
                </p>
                <p>
                    Refund requests, if applicable, must be submitted through the designated process. Approved refunds will be processed only through the original method of payment, subject to internal review and management approval, in accordance with our
                    refund policy.
                </p>
                <div className={styles.line}></div>
                <h2>
                ...
                <p>
                    Users may choose to accept or decline cookies through their browser settings. Please note that disabling cookies may limit access to certain interactive features of
                    the website.
                </p>
                <p>
                ...
                <p>
                    No content may be copied, reproduced, modified, distributed, or used for commercial purposes without prior written consent from Golden
                    Bulls International.
                </p>
                <div className={styles.line}></div>
                <h2>
