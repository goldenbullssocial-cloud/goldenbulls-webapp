...
// Media/Publication logos for marquee
const mediaLogos = [
  { src: "/assets/images/bbc.svg", alt: "BBC" },
  { src: "/assets/images/hindu.svg", alt: "The Hindu" },
        ...
        <div className={styles.grid}>
          <div className={styles.griditems}>
            <div className={styles.box}>
              <h3>Real Reviews. Real Experiences.</h3>
            ...
            <div className={styles.box}>
              <h3>Rated & Reviewed Worldwide</h3>
              <div className={styles.twoAlignment}>
                <div>
                  <img src={CounterIcon} alt="CounterIcon" />
                  <span>Average Rating</span>
          ...
          <div className={styles.griditems}>
            <div className={styles.textstyle}>
              <h3>Recognized by Leading Media</h3>
              <p>
                Our training philosophy, educational resources, and structured
                learning approach have been acknowledged by reputable digital
                publications and financial learning platforms worldwide.
              </p>
            </div>
