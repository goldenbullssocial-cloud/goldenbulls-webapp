    ...
    <div className={styles.meetTheFounder}>
      <div className="container-md">
        <div className={styles.grid}>
          ...
          >
            <motion.h2 variants={textItem}>Meet the Founder</motion.h2>
            ...
            <motion.p variants={textItem}>
              ...
              the markets, Amol created a learning environment focused on
              clarity, structure, and real world application.
            </motion.p>

            <motion.p variants={textItem}>
              His leadership is driven by a commitment to empower learners with
              knowledge, discipline, and confidence, helping them develop the
              skills needed to navigate today’s financial markets with purpose
              and understanding.
            </motion.p>

            {/* SOCIAL ICONS */}
            <motion.div className={styles.socialIcon} variants={textContainer}>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <motion.div className={styles.image} animate={floatingAnimation}>
            ...
            >
              <button
                onClick={() =>
                  window.open(
                    "https://www.youtube.com/watch?v=BXmO5kdqHJY",
                    "_blank",
                  )
                }
              >
